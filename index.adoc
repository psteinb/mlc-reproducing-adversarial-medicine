...
[.XXL-text]#"Adversarial Attacks Against Medical Deep Learning Systems"# +
...
https://github.com/sgfin/adversarial-medicine[github.com/sgfin/adversarial-medicin]
...
[%step]
* For a given set of variations stem:[S]
...
* <<Biggio18>> defines this as Grey-Box attack
* this paper cites <<Biggio18>>
* <<Biggio18>> mentions that DL experts have reinvented/rediscovered what ML security experts have discovered with 5 year delay
...
a|
* very hard to attack
* no noise based attack would lead to misclassification
|===
...
Decision Boundary Attack <<Brendel17>>

[.notes]
--
* high count of calls to model's predict function
--
...
[.notes]
--
* model's predict function was called N times
--
