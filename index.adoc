...
IMPORTANT: PGD <<Madry17>>,<<Kurakin1611>> is a White Box Attack!
...
[cols="^.<,^.<,^.<",width=100%,frame=none,grid=none]
|===
a| image:cxr-original.png[width=90%]
a| image:cxr-adversarial.png[width=90%]
a| image:cxr-diff.png[width=90%]
|===
...
Decision Boundary Attack in <<Brendel17>>
